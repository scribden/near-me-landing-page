...
export default function Page() {
  return (
    <>
      ...
      <section
        className="relative overflow-hidden pt-40 after:content-[''] after:absolute after:inset-0 after:mx-auto after:size-[56rem] after:bg-gradient-to-tl after:to-red-600/40  after:from-indigo-600/40 after:blur-[200px] after:rounded-full after:-z-1"
        id="home"
      >
            ...
            <div className="">
              ...
              <div className="subcribe-form mt-6 mb-3">
                <form className="relative max-w-lg mx-auto">
                  ...
                  <button
                    type="submit"
                    className="size-[46px] inline-flex items-center justify-center rounded-full align-middle absolute top-[2px] end-[3px] bg-red-500 border-red-500 text-white"
                  >
